  ...
  <div class="min-h-screen bg-white">
    ...
    <main class="max-w-5xl mx-auto px-6 py-6 space-y-6" data-testid="status-history-view">
      <header class="flex flex-wrap items-center gap-3">
        <label
          class="inline-flex items-center gap-2 rounded-md border border-gray-200 bg-white px-3 py-1.5 text-sm cursor-pointer"
        >
          <svg
          ...
          <UInput
            ...
            size="xs"
            variant="none"
            :ui="{ base: 'bg-transparent outline-none text-xs font-mono p-0' }"
        ...
        <div
          class="ml-auto inline-flex items-center gap-1.5 text-xs text-gray-500"
          data-testid="counter"
        >
          <svg
            v-if="allResolved && total > 0"
      ...
      <div v-else class="space-y-6">
        ...
        />
        <p v-if="total > 0" class="text-center text-xs text-gray-500" data-testid="footnote">
