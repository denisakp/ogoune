  ...
  <div class="min-h-screen bg-white dark:bg-gray-950">
    ...
    <main class="max-w-5xl mx-auto px-6 py-6 space-y-6" data-testid="status-history-view">
      <header class="flex flex-wrap items-center gap-3">
        <label class="inline-flex items-center gap-2 rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-1.5 text-sm cursor-pointer">
      ...
      <div
        ...
        class="rounded-xl border border-gray-200 dark:border-gray-800 p-12 text-center text-gray-500"
      >
        Loading incidents…
      </div>
