...
SELECT id, created_at, updated_at, name, os, agent_version, last_seen_at, last_cpu_pct, last_mem_pct, last_disk_pct, last_net_in, last_net_out, last_disks, capabilities, capabilities_at FROM hosts WHERE id = $1
`
