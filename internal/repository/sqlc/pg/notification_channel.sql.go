...
SELECT id, created_at, updated_at, name, type, config, enabled_by_default FROM notification_channels WHERE enabled_by_default = true
`
...
SELECT id, created_at, updated_at, name, type, config, enabled_by_default FROM notification_channels WHERE id = $1
`
...
SELECT id, created_at, updated_at, name, type, config, enabled_by_default FROM notification_channels WHERE type = $1
`
