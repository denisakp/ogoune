...
func (q *Queries) DeleteHostEventsByHost(ctx context.Context, hostID string) error {
	_, err := q.db.Exec(ctx, deleteHostEventsByHost, hostID)
	return err
}
...
func (q *Queries) DeleteHostEventsOlderThan(ctx context.Context, occurredAt pgtype.Timestamptz) (int64, error) {
	result, err := q.db.Exec(ctx, deleteHostEventsOlderThan, occurredAt)
	if err != nil {
		return 0, err
	}
...
func (q *Queries) InsertHostEvent(ctx context.Context, arg InsertHostEventParams) error {
	_, err := q.db.Exec(ctx, insertHostEvent,
		arg.ID,
		arg.HostID,
		arg.OccurredAt,
		arg.Kind,
...
func (q *Queries) ListHostEventsByHost(ctx context.Context, arg ListHostEventsByHostParams) ([]HostEvent, error) {
	rows, err := q.db.Query(ctx, listHostEventsByHost, arg.HostID, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
