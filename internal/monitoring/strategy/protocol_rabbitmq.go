...
func rabbitmqCheck(ctx context.Context, r *domain.Resource, host string, port int, useTLS bool, timeout time.Duration, dial DialFunc, _ dbHealthSkipFunc) domain.CheckResult {
