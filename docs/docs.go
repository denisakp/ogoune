...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_denisakp_ogoune_internal_dto_v1.SingleResponse-github_com_denisakp_ogoune_internal_dto_v1_MarkAllReadResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_denisakp_ogoune_internal_dto_v1.SingleResponse-github_com_denisakp_ogoune_internal_dto_v1_CredentialResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_denisakp_ogoune_internal_dto_v1.CredentialCreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_denisakp_ogoune_internal_dto_v1.CredentialTestResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
    ...
    "definitions": {
        ...
        "github_com_denisakp_ogoune_internal_dto_v1.SingleResponse-github_com_denisakp_ogoune_internal_dto_v1_MarkAllReadResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/github_com_denisakp_ogoune_internal_dto_v1.MarkAllReadResponse"
                },
                "meta": {
                    "$ref": "#/definitions/github_com_denisakp_ogoune_internal_dto_v1.MetaResponse"
                }
