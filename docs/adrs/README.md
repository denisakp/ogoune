...
| [0010](./0010-frontend-stack-nuxtui-tailwind-ky-zod.md) | Frontend stack: Nuxt UI + Tailwind v4 + Iconify + Ky + Zod | Accepted | 2026-06-03 | Both | frontend, design-system |
| [0011](./0011-host-metrics-retention-and-incident-correlation.md) | Host metrics retention and incident correlation | Proposed | 2026-09-09 | CE | storage, agent, observability, retention |
| [0012](./0012-correlation-is-a-projection.md) | The incident causal narrative is a projection, never a record | Proposed | 2026-09-10 | CE | observability, correlation, storage, api |
